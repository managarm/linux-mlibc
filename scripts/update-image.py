...
def generate_plan(arch, root_uuid, scriptdir):
    ...
    if arch == "x86_64-linux-mlibc":
        yield FsAction.INSTALL, "boot/vmlinuz-linux", "boot/"
...
parser.add_argument(
    ...
    "--triple",
    dest="arch",
    choices=["x86_64-linux-mlibc", "aarch64-linux-mlibc", "riscv64-linux-mlibc"],
    default="x86_64-linux-mlibc",
    help="Target system triple (needed for the update-fs step, default: x86_64-linux-mlibc)",
)
parser.add_argument(
    "plan",
    metavar="action",
